...
| P-12 | 2026-04-11 | direct-log | UI/E2E tesztfedés bővítése | A PDF szerinti integration_test hiányok alapján reservation/refund/review/QR és admin product moderation flow-k létrehozása, majd a dokumentáció frissítése | Új `integration_test` flow-k, tesztelhetőségi injection pontok és minőség/release dokumentáció frissítése | [`../../mobile/nearpick/integration_test/flows/reservation_refund_review_flow_test.dart`](../../mobile/nearpick/integration_test/flows/reservation_refund_review_flow_test.dart), [`../../mobile/nearpick/integration_test/flows/admin_product_moderation_flow_test.dart`](../../mobile/nearpick/integration_test/flows/admin_product_moderation_flow_test.dart), [`../04_quality/test_report.md`](../04_quality/test_report.md) | Android emulatoros futtatás után finder- és státuszlabel-javításokkal stabilizálva |
