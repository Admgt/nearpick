...
| "A repo tesztmixe eléri a minimum 30+ automata küszöböt" | Téves release-readiness megítélés | Mérés: repo audit és tesztszámlálás (`85` Flutter test definíció + `68` Functions/rules JS teszt, összesen `153`) | Pass | A mennyiségi minimum teljesül, a minőségi és integrációs mélység továbbra is külön kockázat |
