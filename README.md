...
Szakdolgozat PDF: [`docs/08_thesis/NearPick_szakdolgozat.pdf`](docs/08_thesis/NearPick_szakdolgozat.pdf)
...
2. Kattints az `Elfelejtett jelszó?` flow-ra, hogy a reviewer lássa a password reset dialógust is.
3. Jelentkezz be a `demo.merchant@nearpick.local` felhasználóval.
4. Nyisd meg a profil oldalt, és ellenőrizd, hogy a cégnév és céghely elérhető.
5. Nyisd meg az új termék képernyőt, adj meg nevet, kategóriát, árakat, készletet, lejáratot, kérj árjavaslatot, majd mentsd a terméket.
6. Ellenőrizd, hogy a termék megjelenik a kereskedői listában, és ha nincs rajta foglalás, szerkeszthető.
7. Jelentkezz ki, majd lépj be a `demo.user@nearpick.local` felhasználóval.
...
3. Hozz létre egy egyszerű terméket, vagy nyisd meg az egyik aktív ajánlatot.
